<template>
  <r-app>
    ...
    <r-section>
      <r-form :class="$prefix('w-1/2 mx-auto')">
        <div :class="$prefix('flex -m-2')">
          <r-checkbox
        ...
        <div :class="$prefix('flex flex-wrap -mx-2')">
          <div :class="$prefix('px-2 w-100 md:w-8/12')">
            <r-input label="Street" v-bind="fieldProps('street')" v-on="fieldListeners('street')" />
          </div>
          <div :class="$prefix('px-2 w-100 md:w-4/12')">
          ...
          <div :class="$prefix('px-2 w-100 md:w-7/12')">
          ...
          <div :class="$prefix('px-2 w-100 md:w-6/12')">
